...
<body>
                    ...
                    <div class="d-flex m-3 me-0">
                        ...
                        <div class="nav-item dropdown">
                            <a href="#" class="nav-link dropdown-toggle my-auto mt-2" data-bs-toggle="dropdown">
                                <img src="{{ Auth::user()->profile == "" ? asset('default/userProfile.png' ) : asset('user/profile/' . Auth::user()->profile) }}" style="width: 40px; height:40px;" class="img-profile  rounded-circle" alt="">
                                <span></span>
                            </a>
                            <div class="dropdown-menu m-0 bg-secondary rounded-0">
                                <a href="{{ route('editPage', Auth::user()->id ) }}" class="dropdown-item my-2">Edit Profile</a>
                                <a href="{{ route('changePasswordPage') }}" class="dropdown-item my-2">Change Password</a>
    ...
    <script src="{{ asset('user/css/custom.css') }}x"></script>
